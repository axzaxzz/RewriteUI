...
function library:Init(key)
    ...
    edgeCorner.CornerRadius = UDim.new(0, 16)  -- Matcha: 16px rounded corners
    edgeCorner.Name = "edgeCorner"
    edgeCorner.Parent = edge
    ...
    backgroundCorner.CornerRadius = UDim.new(0, 16)  -- Matcha: 16px rounded corners
    backgroundCorner.Name = "backgroundCorner"
    backgroundCorner.Parent = background
    ...
    tabButtonCorner.CornerRadius = UDim.new(0, 8)  -- Matcha: 8px for inner containers
    ...
    tabButtonCorner_2.CornerRadius = UDim.new(0, 8)  -- Matcha: 8px for inner containers
    ...
    tabButtonCorner_3.CornerRadius = UDim.new(0, 8)  -- Matcha: 8px for inner containers
    ...
    containerCorner.CornerRadius = UDim.new(0, 8)  -- Matcha: 8px for inner containers
